...
<asp:GridView ID="gv1" runat="server" Width="838px" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Line 1 Text\Icons">
                <EditItemTemplate>
                ...
                <ItemTemplate>
                    ...
                    <br />
                    <asp:Label ID="Label6" runat="server" Font-Italic="True" Font-Size="5pt" 
                        Text='<%# Bind("cap") %>'></asp:Label>
                    <br />
                    <asp:Label ID="Label7" runat="server" Font-Italic="True" Font-Size="5pt" 
                        Text='<%# Bind("cap1") %>'></asp:Label>
                    <br />
                </ItemTemplate>
            </asp:TemplateField>
...
<div align="right" style="height: 31px; float: right;">
    ...
    <asp:FormView ID="FormView2" runat="server" DataSourceID="dstotal">
        ...
        <tr>
        <td align="right">  <asp:Label ID="Label1" runat="server" Text="Total: "></asp:Label> </td><td> <asp:TextBox ID="txttotal" runat="server" ReadOnly="True" Width="60px" 
                Text='<%# bind("total") %>'></asp:TextBox> </td>
        </tr>
        </table>
